...
class TypeOfExercise(BodyPartAngle):
    ...
    def push_up(self, counter, status):
        left_arm_angle = self.angle_left_arm()
        right_arm_angle = self.angle_left_arm()
    ...
    def pull_up(self, counter, status):
        ...
        left_elbow = detect_body_part(self.landmarks, "LEFT_ELBOW")
        right_elbow = detect_body_part(self.landmarks, "RIGHT_ELBOW")
    ...
    def walk(self, counter, status):
        right_knee = detect_body_part(self.landmarks, "RIGHT_KNEE")
        left_knee = detect_body_part(self.landmarks, "LEFT_KNEE")
